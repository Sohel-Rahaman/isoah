...
const Navbar = () => {
  ...
  return (
    <nav
      className={`text-[#ddd] fixed w-full z-30 transition-all duration-300 ${showNavbar ? 'top-0' : '-top-20' // Adjust '-top-20' based on navbar height
        }`}
  ...
  height={500}src="/f.webp" className='h-10 w-10 me-3' alt="" /> <div className='text-[25px] md:text-[30px] '>ForensicsHQ</div>
          ...
          <div className="flex items-center md:hidden">
            <button
              onClick={toggleMenu}
              type="button"
              className="inline-flex items-center justify-center p-2 rounded-md text-[#ddd] hover:text-[#ddd] hover:bg-black-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500"
  ...
  height={500}src="/f.webp" className='h-10 w-10 me-3' alt="" /> <div className='text-[20px] md:text-[30px] '>ForensicsHQ</div>
            ...
            <button
              onClick={toggleMenu}
              type="button"
              className="inline-flex items-center justify-center p-2 rounded-md text-[#ddd] hover:text-[#000319] hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500"
            >
          ...
          <div className="px-2 pt-2 pb-3 space-y-1">
            <Link
              href="/"
              className="block px-3 py-2 rounded-md text-base font-medium text-[#ddd] hover:text-[#000319] hover:bg-gray-50"
              onClick={closeMenu}
            >
              Home
            </Link>
            ...
            <div className="space-y-1">
              <button
                ...
                className="w-full flex items-center justify-between px-3 py-2 rounded-md text-base font-medium text-[#ddd] hover:text-[#000319] hover:bg-gray-50 focus:outline-none"
              >
                Services
                <svg
